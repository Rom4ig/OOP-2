...
namespace OOP_4_5_TEST
{
    public partial class MainWindow : Window
    {
        ...
        {
            Resources = new ResourceDictionary() { Source = new Uri(@"C:\Users\Roman\Desktop\4 семестр\ООП\WPF-master\OOP_4-5_TEST\OOP_4-5_TEST\Dictionary2.xaml") };

        }

        private void Button_Click_1(object sender, RoutedEventArgs e)
        {
            Resources = new ResourceDictionary() { Source = new Uri(@"C:\Users\Roman\Desktop\4 семестр\ООП\WPF-master\OOP_4-5_TEST\OOP_4-5_TEST\Dictionary1.xaml") };
        }
